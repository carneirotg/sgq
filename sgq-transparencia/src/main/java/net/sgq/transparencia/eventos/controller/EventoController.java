...
public interface EventoController {
	...
	@ApiOperation(value = "Incidentes em formato JSON", response = IncidenteTO.class, responseContainer = "List")
	...
	@ApiOperation(value = "Incidentes em formato XML", response = Incidentes.class)
	...
	@ApiOperation(value = "Campanhas em formato JSON", response = CampanhaRecallTO.class, responseContainer = "List")
	...
	@ApiOperation(value = "Campanhas em formato JSON", response = Campanhas.class)
