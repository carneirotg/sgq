...
public interface IncidenteController {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Incidentes retornados com sucesso"),
			@ApiResponse(code = 404, message = "Nenhum incidente encontrado") })
	ResponseEntity<List<Incidente>> incidentesAbertos(String titulo, Integer pagina, Integer registros, Boolean descSort);

	@ApiOperation(value = "Consulta incidentes com estado 'Em Análise'", response = Incidente.class, responseContainer = "List")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Incidentes retornados com sucesso"),
			@ApiResponse(code = 404, message = "Nenhum incidente encontrado") })
	ResponseEntity<List<Incidente>> incidentesEmAnalise(String titulo, Integer pagina, Integer registros, Boolean descSort);

	@ApiOperation(value = "Consulta incidentes com estado 'Concluído'", response = Incidente.class, responseContainer = "List")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Incidentes retornados com sucesso"),
			@ApiResponse(code = 404, message = "Nenhum incidente encontrado") })
	ResponseEntity<List<Incidente>> incidentesConcluidos(String titulo, Integer pagina, Integer registros, Boolean descSort);
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Incidentes retornados com sucesso"),
			@ApiResponse(code = 404, message = "Nenhum incidente encontrado") })
	ResponseEntity<List<Incidente>> incidentesNaoConcluidos(Integer pagina, Integer registros, Boolean descSort);
