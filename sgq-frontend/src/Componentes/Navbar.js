                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="mr-auto">
                        ...
                        <NavDropdown title="Incidentes" id="basic-nav-dropdown">
                            ...
                            <NavDropdown.Item as={Link} to="/dashboard/incidentes">Buscar</NavDropdown.Item>
                        ...
                        <NavDropdown title="Campanhas" id="basic-nav-dropdown">
                            ...
                            <ComponenteProtegido papel="GESTOR">
                                <NavDropdown.Divider />
                                <NavDropdown.Item as={Link} to="/dashboard/comunicados">Comunicados</NavDropdown.Item>
                            </ComponenteProtegido>
                        </NavDropdown>
